...
# CO2
validation_index <- createDataPartition(CO2_1_standardized$CO2, p=0.60, list=FALSE)
validation <- CO2_1_standardized[-validation_index,]
d.mrakova.sensor1.selectedCO2 <- CO2_1_standardized[validation_index,]
...
#Scatter Plot
#plot(d.mrakova.sensor1.selectedCO2)
