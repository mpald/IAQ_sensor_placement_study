...
# Support vector machine regression model for sensor 1, VOC index

The amount of observations after reduction and the summary of training data set.

```{r predsens1 VOC,  warning=FALSE}
...
#reducing dataset 
d.mrakova.sensor1.small = d.mrakova.sensor1[seq(1, nrow(d.mrakova.sensor1), 0), ]
...
#dim(d.mrakova.sensor1.selectedVOC)

#levels(d.mrakova.sensor1.selectedVOC$VOC_index)

summary(d.mrakova.sensor1.selectedVOC)

```

## Support vector regression: version 1

### Fit SVR model and visualize using scatter plot

Training and prediction.

```{r SVRbasic,  warning=FALSE}
