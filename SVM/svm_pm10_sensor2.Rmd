...
# Support vector machine regression model for sensor 2, PM10
...
d.mrakova.sensor2.selectedPM10<- d.mrakova.sensor2.small %>% select(T, RH, PM10, p, ambient_light, CO2, VOC_index, created_at)

#standardizacija
PM10_2_standardized <- 
  d.mrakova.sensor2.selectedPM10 %>% 
...
validation_index2 <- createDataPartition(PM10_2_standardized$PM10, p=0.60, list=FALSE)
validation2 <- PM10_2_standardized[-validation_index2,]
d.mrakova.sensor2.selectedPM10 <- PM10_2_standardized[validation_index2,]

#dim(d.mrakova.sensor2.selectedPM10)

#levels(d.mrakova.sensor2.selectedPM10$PM10)

summary(d.mrakova.sensor2.selectedPM10)
...
#Scatter Plot
#plot(d.mrakova.sensor2.selectedPM10)

# regression training model SVM
model2 <- svm(PM10~T + RH + CO2 + p + ambient_light+ VOC_index, data = d.mrakova.sensor2.selectedPM10)
summary(model2)

#Predict using SVM regression
pred_PM10_s2 = predict(model2, newdata=validation2)

validation_s2_new1 <- cbind(validation2, pred_PM10_s2)
...
validation_s2_new1_graph <- validation_s2_new1 %>%
   mutate(date = as.POSIXct(created_at), format="%Y-%m-%d %H:%M:%S") %>% select(date, pred_PM10_s2, PM10) %>%
...
# RMSE
sqrt(mean((validation_s2_new1$PM10 - validation_s2_new1$pred_PM10_s2)^2))
...
# R2
cor(validation_s2_new1$PM10, validation_s2_new1$pred_PM10_s2) ^ 2
